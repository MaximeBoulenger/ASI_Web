            ...
            <div class="card-body">
                <div class="card-text mt-1 mb-1">
                    <form>
                        ...
                        <CustomInput v-model="currentParcours.AnneeFormation" class="mt-2" id="annee" libelle="Année"
                            type="number" placeholder="Année de formation" :error=" formErrors.AnneeFormation" />
                    </form>
                </div>
                ...
                <CustomButton class="mt-1" style="margin-left: 5px" :color="BootstrapButtonEnum.primary"
                    @click="saveParcours" :disabled="currentParcours.NomParcours == null || currentParcours.AnneeFormation == null ||  formErrors.NomParcours || formErrors.AnneeFormation">
                    Enregistrer
                </CustomButton>
            </div>
        </div>
